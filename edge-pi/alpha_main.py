...
#                 # ====================================================
#                 # 💡 궁극의 버그 방어막: 1번(전도), 2번(충돌) 외에는 전부 무시!
#                 # 아두이노가 0(정상), 3(급가속), 4(급정거), 5(이탈)일 때 
#                 # 실수로 사고(True) 신호를 보내도 강제로 평온(False) 상태로 덮어씁니다.
#                 # ====================================================
#                 if event_label not in [1, 2]:
#                     is_accident = False 
